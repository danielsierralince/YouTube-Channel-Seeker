...
class Window(QMainWindow):
    def __init__(self):
        ...
        self.searchButton.setGeometry(QRect(200, 20, 140, 30))
        ...
        self.fillButton.setGeometry(QRect(680, 20, 270, 30))
