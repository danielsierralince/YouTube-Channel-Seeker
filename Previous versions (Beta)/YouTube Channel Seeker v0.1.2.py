...
class Window2(QDialog):
    def __init__(self):
        ...
        self.table.setFixedSize(159, 115)
        ...
        self.addRowButton.setGeometry(QtCore.QRect(220, 45, 100, 30))
        self.addRowButton.clicked.connect(self.save_data)
        
        #El boton de añadir
        self.addRowButton = QPushButton('Add', self)
        self.addRowButton.setGeometry(QtCore.QRect(220, 85, 100, 30))
        self.addRowButton.clicked.connect(self.add_data)
        
        #El boton de vaciar columna
        self.addRowButton = QPushButton('Delete', self)
        self.addRowButton.setGeometry(QtCore.QRect(220, 125, 100, 30))
        self.addRowButton.clicked.connect(self.delete_column)
    ...
    #Funcion de eliminar fila del boton Delete
    def delete_column(self):
        #Eliminamos el numero de filas del tamaño de la tabla y la columna 0
        for num_filas in range(self.table.rowCount()):
            self.table.takeItem(num_filas, 0)
